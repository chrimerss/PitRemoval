...
SOURCES = \
	__init__.py \
	pit_removal.py pit_removal_dialog.py

PLUGINNAME = pit_removal

PY_FILES = \
	__init__.py \
	pit_removal.py pit_removal_dialog.py

UI_FILES = pit_removal_dialog_base.ui
...
QGISDIR=/Users/allen/Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins
